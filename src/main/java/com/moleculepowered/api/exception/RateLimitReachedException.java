...
public class RateLimitReachedException extends RuntimeException {
    ...
    /**
     * Constructs a new rate limit reached exception with {@code null} as its
    ...
    /**
     * Constructs a new rate limit reached with the specified detail message.
     ...
     */
    public RateLimitReachedException(String message, Object... param) {
        super(format(message, param));
    }

    /**
     * Constructs a new rate limit reached with the specified detail message and
     ...
     */
    public RateLimitReachedException(String message, Throwable cause, Object... param) {
        super(format(message, param), cause);
    }

    /**
     * Constructs a new rate limit reached with the specified cause and a
    ...
    /**
     * Constructs a new rate limit reached with the specified detail
     ...
     */
    protected RateLimitReachedException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace, Object... param) {
